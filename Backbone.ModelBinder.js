// Backbone.ModelBinder v1.0.6 (with components support)
// (c) 2013 Bart Wood
...
(function (factory) {
    ...
    if (!Backbone.ComponentBinder) {
        throw 'Please include Backbone.ComponentBinder.js before Backbone.ModelBinder.js';
    }
    ...
    Backbone.ModelBinder.VERSION = '1.0.7';
